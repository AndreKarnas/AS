...
@section('content')
    <form class="max-w-sm mx-auto" action="{{ url('empresas') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-5">
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" type="submit">Criar Empresa</button>
    </form>
@endsection
